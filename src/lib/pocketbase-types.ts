...
export type KidsResponse<Texpand = unknown> = Required<KidsRecord> & BaseSystemFields<Texpand>
...
export type TypedPocketBase = PocketBase & {
	...
	collection(idOrName: 'kids'): RecordService<KidsResponse>
